...
class Partition(object):
    ...
    def print_token_stats(self, total_token_count):
        print(f"Total token count: {total_token_count}", file=sys.stderr)
    ...
    def process_json_file(self, file_name):
        ...
        print("Opening", input_file_name)
        # support jsonl.zst
        if input_file_name.endswith(".jsonl.zst") or input_file_name.endswith(".jsonl.zstd"):
            fin=zstd.open(open(input_file_name, 'rb'), 'rt', encoding='utf-8')
        elif input_file_name.endswith(".jsonl.gz"):
...
def get_args():
    ...
    group.add_argument('--tokenizer-type', type=str, required=True,
                       choices=['BertWordPieceLowerCase','BertWordPieceCase',
                                ...
                                'GPTSentencePieceTokenizer', 'HuggingFaceTokenizer', 
                                'Llama2Tokenizer', 'Llama3Tokenizer', 'MistralTokenizer', 
                                'TikTokenizer', 'NullTokenizer'],
