...
from transformers.modeling_utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME, dtype_byte_size
...
def shard_checkpoint(
    state_dict, max_shard_size="10GB", weights_name=WEIGHTS_NAME
):
...
def load_checkpoint(args):
    ...
    margs.tensor_model_parallel_size = 8
...
def main():
    ...
    parser.add_argument("--max_shard_size", type=str, default="50GB",
        help=(
