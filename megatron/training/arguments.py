...
def _add_logging_args(parser):
    ...
    group.add_argument('--log-per-layer-grad-norm', action='store_true',
                       help='If set, calculate and log per-layer gradient norms.')
    group.add_argument('--log-per-layer-grad-norm-freq', type=str, default='interval',
                     choices=['interval', 'every_step'],
                     help='Frequency for calculating and logging per-parameter gradient norms. "interval" logs every log_interval, "every_step" logs every iteration.')
